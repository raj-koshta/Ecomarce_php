...
<body>
                           ...
                           <div class="row align-items-center">
                              <div class="col-xl-5 col-lg-6 col-md-6">
                                 <div class="tp-slider-content p-relative z-index-1">
                                    ...
                                    <h3 class="tp-slider-title"><?php echo $banner->title?></h3>
                                    <!-- <p>Exclusive offer
                                       <span>-35%
                           ...
                           <div class="row">
                              <?php if (!empty($products)) {
                                 foreach ($products as $product) {
                                    $category_name = $this->HomeModel->get_category_name($product->category);
                                    ?>
                                       ...
                                       <div class="tp-product-item p-relative transition-3 mb-25">
                                             ...
                                             <div class="tp-product-action">
                                                <div class="tp-product-action-item d-flex flex-column">
                                                   <form action="<?= base_url('member/add_to_cart'); ?>" method="post"
                                                      ...
                                                      <input class="tp-cart-input" name="product_qty" type="hidden" value="1">
                                                      <button type="submit"
                                                   ...
                                                   <button type="button" data-product-id="<?= $product->product_id ?>"
                                          ...
                                          <div class="tp-product-content">
                                             <div class="tp-product-category">
                                                <a href="product/<?= $product->slug ?>"><?= $category_name ?></a>
                                             </div>
                                             ...
                                             <div class="tp-product-price-wrapper">
                                                <span
                                                   class="tp-product-price old-price">$<?= number_format($product->mrp, 2) ?></span>
                                                <span
                                                   class="tp-product-price new-price">$<?= number_format($product->selling_price, 2) ?></span>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
               ...
               <div class="tp-product-modal-content d-lg-flex align-items-start">
                        ...
                        <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab"
                           ...
                           <div class="tp-product-details-nav-main-thumb">
                              <img class="product-main-image"
                                 src="assets/frontend/img/product/details/main/product-details-main-1.jpg" alt="">
                           </div>
                        </div>
                  ...
                  <div class="tp-product-details-wrapper">
                     <div class="tp-product-details-category">
                        <span class="product-brand">Computers & Tablets</span>
                     </div>
                     ...
                     <p class="product-highlights">A Screen Everyone Will Love: Whether your family is streaming
                        or video chatting with
                        friends tablet A8...</p>
   ...
   <script>
      $(document).on('click', '.tp-product-quick-view-btn', function () {
         ...
         $.ajax({
            url: 'member/get_product_details_by_id/' + productId,
            type: 'GET',
            dataType: 'json',
            success: function (response) {
               if (response.status === 'success') {
                  ...
                  $('#producQuickViewModal .tp-product-details-title').text(product.product_name);
                  $('#producQuickViewModal .product-brand').text(product.brand);
                  if (product.stock > 0) {
                     $('#producQuickViewModal .product-stock').text('In Stock');
                  } else {
                     $('#producQuickViewModal .product-stock')
                        .text('Out Of Stock')
                        .css({
                           'color': 'red',
                           'background-color': 'rgb(255 9 9 / 6%)'
                        });
                  }
                  $('#producQuickViewModal .product-highlights').text(product.highlights);
                  $('#producQuickViewModal .product-main-image').attr('src', 'uploads/products/' + product.product_main_image);

                  $('#producQuickViewModal .tp-product-details-price.old-price')
                     .text('$' + parseFloat(product.mrp).toFixed(2));

                  $('#producQuickViewModal .tp-product-details-price.new-price')
                     .text('$' + parseFloat(product.selling_price).toFixed(2));

                  $('#producQuickViewModal .product_id').val(product.product_id);
