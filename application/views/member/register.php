...
<body>
                            ...
                            <div class="tp-login-option">
                                <!-- <div
                                    ...
                                    <div class="tp-login-option-item">
                                        <a href="#">
                                            <img src="assets/frontend/img/icon/login/facebook.svg" alt="">
                                        </a>
                                    </div>
                                    <div class="tp-login-option-item">
                                        <a href="#">
                                            <img class="apple" src="assets/frontend/img/icon/login/apple.svg" alt="">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input">
                                            <input id="name" type="text" name="username" placeholder="Shahnewaz Sakil"
                                                value="<?= set_value('username', !empty($data) ? $data['username'] : "") ?>">
    ...
    <?php if (!empty($this->session->flashdata('registerErrorMsg'))): ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: '<?= $this->session->flashdata('registerErrorMsg') ?>',
