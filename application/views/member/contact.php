                            ...
                            <div class="tp-contact-wrapper">
                                ...
                                <div class="tp-contact-form">
                                    <form id="contact-form"
                                        action="member/add_inquiry"
                                        method="POST">
                                        <div class="tp-contact-input-wrapper">
                                            <div class="tp-contact-input-box">
                                                <div class="tp-contact-input">
                                                    <input name="name" id="name" type="text"
                                                        placeholder="Karan Sakil" required>
                                                </div>
                                            ...
                                            <div class="tp-contact-input-box">
                                                <div class="tp-contact-input">
                                                    <input name="email" id="email" type="email"
                                                        placeholder="xyz@mail.com" required>
                                                </div>
                                                <div class="tp-contact-input-title">
                            ...
                            <div class="tp-contact-info-wrapper">
                                <div class="tp-contact-info-item">
                                    <div class="tp-contact-info-icon">
                                        <span>
                                            <img src="assets/frontend/img/contact/contact-icon-1.png" alt="">
                                        </span>
                                    </div>
                                    <div class="tp-contact-info-content">
                                        <p data-info="mail"><a
                                                href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#bdded2d3c9dcdec9fdced5d2dbc493ded2d0"><span
                                                    class="__cf_email__"
                                                    data-cfemail="294a46475d484a5d695a41464f50074a4644">[email&#160;protected]</span></a>
                                        </p>
                                        <p data-info="phone"><a href="tel:670-413-90-762">+123 456 67 789</a></p>
                                    </div>
                                </div>
                                <div class="tp-contact-info-item">
                                    <div class="tp-contact-info-icon">
                                        <span>
                                            <img src="assets/frontend/img/contact/contact-icon-2.png" alt="">
                                        </span>
                                    </div>
                                    <div class="tp-contact-info-content">
                                        <p>
                                ...
                                <div class="tp-contact-info-item">
                                    <div class="tp-contact-info-icon">
                                        <span>
                                            <img src="assets/frontend/img/contact/contact-icon-3.png" alt="">
                                        </span>
                                    </div>
                                    <div class="tp-contact-info-content">
