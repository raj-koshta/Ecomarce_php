                            ...
                            <div class="tp-shop-items-wrapper tp-shop-item-primary">
                                <div class="tab-content" id="productTabContent">
                                    <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel"
                                        ...
                                        <div class="row infinite-container mb-70">
                                                        ...
                                                        <div class="tp-product-item-2 mb-40">
                                                            ...
                                                            <div class="tp-product-content-2 pt-15">
                                                                ...
                                                                <div class="tp-product-price-wrapper-2">
                                                                    ...
                                                                    <span
                                                                        class="tp-product-price-2 old-price">$<?= number_format($product->mrp, 2) ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="tp-product-list-item d-md-flex">
                                                                ...
                                                                <div class="tp-product-list-content">
                                                                    <div class="tp-product-content-2 pt-15">
                                                                        <div class="tp-product-tag-2">
                                                                            <a
                                                                                href="javascript:void(0)"><?= $product->brand ?></a>
                                                                        </div>
                                                                        <h3 class="tp-product-title-2">
                                                                            <a
                                                                                href="product/<?= $product->slug ?>"><?= $product->product_name ?></a>
                                                                        ...
                                                                        <p><?= substr($product->highlights, 0, 100) ?></p>
                                ...
                                <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                    ...
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img class="product-main-image"
                                            src="assets/frontend/img/product/details/main/product-details-main-1.jpg"
                                            alt="">
                                    </div>
                                </div>
