...
<head>
    ...
    <style>
        ...
        .review-scroll-area {
            max-height: 200px;
            /* adjust height to fit ~3 reviews */
            overflow-y: auto;
            /* enable vertical scrollbar */
            padding-right: 10px;
            padding-top: 20px;
            /* prevent text cut-off behind scrollbar */
        }
...
<body>
    ...
    <main>
        ...
        <section class="tp-product-details-area">
                    ...
                    <div class="row">
                                ...
                                <!-- <nav>
                                    <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb"
                                        ...
                                        <button class="nav-link" id="nav-5-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false">
                                            <img src="assets/frontend/img/product/details/nav/product-details-nav-5.jpg" alt="">
                                        </button>
                                    </div>
                                </nav> -->
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                ...
                                <div class="tp-product-details-action-wrapper">
                                    ...
                                    <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                                        ...
                                        <!-- <div class="tp-product-details-add-to-cart mb-15 w-25">
                                            <a href="#"class="tp-product-details-wishlist-btn">
                                ...
                                <?= form_close() ?>
                                <form action="<?= base_url('member/add-to-wishlist'); ?>" method="post">
                                ...
                                <div class="tp-product-details-query">
                                    ...
                                    <div class="tp-product-details-query-item d-flex align-items-center">
                                        <span>Category: </span>
                                        <?php $category_id = $this->ProductModel->fetch_product_category_id($product->slug); ?>
                                        <p><?= $this->HomeModel->get_category_name($category_id) ?></p>
                                    </div>
                                </div>
            ...
            <div class="tp-product-details-bottom pb-30">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-description" role="tabpanel"
                                        ...
                                        <div class="tp-product-details-desc-wrapper pt-80">
                                            <div class="row justify-content-center">
                                                <div class="col-xl-10">
                                                    <div class="tp-product-details-desc-item pb-30">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="tp-product-details-review-form">
                                                        ...
                                                        <p>Your email address will not be published.
                                                            marked *</p>
                                                        <form action="member/add-review" method="post">
                                                            <div
                                                            ...
                                                            <div class="tp-product-details-review-input-wrapper">
                                                                <div class="tp-product-details-review-input-box">
                                                                    <div class="tp-product-details-review-input">
                                                                        <textarea id="msg" name="review_msg"
                                            ...
                                            <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                                <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                                    <a href="product/<?= $relatedProduct->slug ?>">
                                                        <img src="uploads/products/<?= $relatedProduct->product_main_image ?>"
                                                            alt="">
                                                    </a>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="tp-product-action-item-3 d-flex flex-column">
                                                            <form action="<?= base_url('member/add_to_cart'); ?>" method="post"
                                                                class="d-inline">
                                                                <input class="" name="product_id" type="hidden"
                                                                    value="<?= $relatedProduct->product_id ?>">
                                                                <input class="tp-cart-input" name="product_qty" type="hidden"
                                                                    value="1">
                                                                <button type="submit"
                                                            ...
                                                            <form action="<?= base_url('member/add-to-wishlist'); ?>"
                                                    ...
                                                    <div class="tp-product-add-cart-btn-large-wrapper">
                                                        <form action="<?= base_url('member/add_to_cart'); ?>" method="post"
                                                            ...
                                                            <input class="tp-cart-input" name="product_qty" type="hidden"
                                                                value="1">
                                                            <button type="submit" class="tp-product-add-cart-btn-large">
                                                                Add To Cart
                                                            </button>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="tp-product-content-3">
                                                    <div class="tp-product-tag-3">
                                                        <?php $category_id2 = $this->ProductModel->fetch_product_category_id($relatedProduct->slug); ?>
                                                        <span><?= $this->HomeModel->get_category_name($category_id2) ?></span>
                                                    </div>
                                                    <h3 class="tp-product-title-3">
                                                        <a
                                                            href="product/<?= $relatedProduct->slug ?>"><?= $relatedProduct->product_name ?></a>
                                                    </h3>
                                                    <div class="tp-product-price-wrapper-3">
                                                        <span
                                                            class="tp-product-price-3 new-price">$<?= number_format($relatedProduct->selling_price, 2) ?></span>
                                                        <span
                                                            class="tp-product-price-3 old-price">$<?= number_format($relatedProduct->mrp, 2) ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                            <nav>
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1"
                                        aria-selected="true">
                                        <img src="assets/frontend/img/product/details/nav/product-details-nav-1.jpg"
                                            alt="">
                                    </button>
                                    <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                                        ...
                                        <img src="assets/frontend/img/product/details/nav/product-details-nav-2.jpg"
                                            alt="">
                                    </button>
                                    <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                                        ...
                                        <img src="assets/frontend/img/product/details/nav/product-details-nav-3.jpg"
                                            alt="">
                                    </button>
                                    <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4"
                                        ...
                                        <img src="assets/frontend/img/product/details/nav/product-details-nav-4.jpg"
                                            alt="">
                                    </button>
                                </div>
                            </nav>
                            <div class="tab-content m-img" id="productDetailsNavContent">
                                <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                    aria-labelledby="nav-1-tab" tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/frontend/img/product/details/main/product-details-main-1.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab"
                                    tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/frontend/img/product/details/main/product-details-main-2.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab"
                                    tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/frontend/img/product/details/main/product-details-main-3.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab"
                                    tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="assets/frontend/img/product/details/main/product-details-main-4.jpg"
                                            alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).on('click', '#star-rating span', function () {
            ...
            $('#star-rating span i').removeClass('fa-solid fa-star').addClass('fa-regular fa-star');

            // activate selected stars
            $('#star-rating span').each(function () {
                if ($(this).data('value') <= rating) {
                    $(this).addClass('active');
                    $(this).find('i').removeClass('fa-regular fa-star').addClass('fa-solid fa-star');
                }
            });
        });
